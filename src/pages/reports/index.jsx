  ...
  useEffect(() => {
    setReportList(
      data?.data?.results.map((rep) => ({
        statdata: {
          assigned: rep.assignedDateCount,
          selected: rep.selectedDateCount,
          offered: rep.offeredDateCOunt,
          joined: rep.joinedDateCount,
          period_complete: rep.PeriodCompletedCount,
        },
        graphdata: {
          labels: [
            "assignedDateCount",
