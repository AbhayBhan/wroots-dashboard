...
import { getCompletedPayouts } from "@/services/Payouts";
...
const [isLoading, setIsLoading]=useState(true);
  ...
  const {mutate}=useMutation(getCompletedPayouts,{
    onSuccess: ({data})=>{
...
export default PaymentCompletedTable;
